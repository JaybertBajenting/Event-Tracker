  ...
  const sortedEvents = useMemo(
    () =>
      [...(filteredEvents || [])].sort((a, b) =>
        b.eventStarts && a.eventStarts
          ? new Date(b.eventStarts).getTime() -
            new Date(a.eventStarts).getTime()
          : 0
      ),
    [filteredEvents]
  );
  ...
  return (
    <div className="flex h-[100%] flex-1 flex-col">
      <div className="mt-[4rem] ml-[4rem]">
        <h1 className="text-[50px] font-bold"> Your Events</h1>
      </div>
      <div className="flex flex-1 flex-wrap justify-center gap-3 bg-opacity-5 pt-10">
